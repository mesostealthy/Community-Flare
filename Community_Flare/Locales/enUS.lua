...
L["Automatically play a sound upon getting a Killing Blow?"] = true
...
L["Automatically take a screenshot upon getting a Killing Blow?"] = true
L["Battleground Options"] = true
L["Block Tooltips inside PVP content?"] = true
...
L["Killshot Options"] = true
L["Leaders Only"] = true
L["Local Warning Only"] = true
L["Log key War Supply Crate Locations?"] = true
L["Log roster list for matches from these communities?"] = true
L["Main Community?"] = true
L["Mark treasure location for Decor Treasure Hunt Quest?"] = true
L["Max (540)"] = true
...
L["Purge Members?"] = true
L["Purge logged roster matches timeframe?"] = true
L["Purge logged War Supply Crate Locations timeframe?"] = true
...
L["This will add a waypoint to the treasure location upon accepting the Decor Treasure Hunt quests."] = true
...
L["This will automatically play a sound when you score a Killing Blow."] = true
...
L["This will automatically take a screenshot when you score a Killing Blow."] = true
L["This will block Tooltips while in PVP content. (Hold Shift to override and show Tooltip.)"] = true
...
L["This will enable the Assist Button when your team has a Main Assist set."] = true
...
L["This will lock the Assist Button to the current position."] = "Cela verrouillera le bouton d'assistance dans sa position actuelle."
...
L["This will provide a warning message when you are low or out of War Mode PVP items when queuing."] = true
L["This will save some key locations when a War Supply Crate is detected."] = true
L["This will send messages to your group about incoming War Supply Crates."] = true
...
L["This will show you warning messages for critical events around Slayer's Rise."] = true
...
L["Use this to purge old members in database from currently selected communities."] = true
...
L["Warn when you are low or out of War Mode PVP Items?"] = true
...
L["Brawl: Cooking: Impossible"] = true
L["Brawl: Deep Six"] = true
L["Brawl: Deepwind Dunk"] = true
L["Brawl: Gravity Lapse"] = true
L["Brawl: Packed House"] = true
L["Brawl: Shado-Pan Showdown"] = true
...
L["%s: Updated member %s to %s."] = true
L["-%s = %d member/s"] = true
L["Count: %d"] = true
L["Inactive: %s"] = true
...
L["Not Member: %s"] = true
L["Pruning community database member list."] = true
...
L["%s: Inviting %s will remove you from queue!"] = true
...
L["%s: Pruned %d Member GUIDs."] = true
...
L["Found: %d War Supply Crate Locations."] = true
L["Harmful Auras:"] = true
L["Helpful Auras:"] = true
L["Instance ID: %d"] = true
L["Last Estimated Spawn Time: %s"] = true
...
-- StaticPopups.lua
L["AFK"] = true
L["Are you sure you delete %s Community?"] = true
...
L["WARNING: Low or out of War Mode PVP Items! Go get some!"] = true
L["West"] = true
