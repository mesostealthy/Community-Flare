...
L["Hide the Cooldown Manager while mounted?"] = true
...
L["This will automatically equip your PVP Gear Set upon queing for a battleground."] = true
...
L["This will hide the Cooldown Manager while mounted in all Content."] = true
