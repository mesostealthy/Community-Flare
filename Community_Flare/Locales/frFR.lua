...
L["%s Currently Queued For %s."] = "%s actuellement en file d'attente pour %s."
...
L["%s: No Groups have popped recently."] = "%s : aucun groupe n'a été affiché récemment."
...
L["Frame positions have been reset."] = "Les positions des cadres ont été réinitialisées."
