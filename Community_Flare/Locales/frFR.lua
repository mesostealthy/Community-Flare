...
L["Automatically play a sound upon getting a Killing Blow?"] = "Jouer automatiquement un son lors d'un coup fatal ?"
...
L["Automatically take a screenshot upon getting a Killing Blow?"] = "Prendre automatiquement une capture d'écran lors d'un coup fatal ?"
...
L["Display a message showing your Kill Streak upon getting a Killing Blow?"] = "Afficher un message indiquant votre série d'éliminations lorsque vous portez le coup fatal ?"
...
L["Killshot Options"] = "Options de tir fatal"
L["Leaders Only"] = "Seulement les Chefs"
L["Local Warning Only"] = "Avertissement local uniquement"
L["Log key War Supply Crate Locations?"] = "Enregistrer les emplacements clés des caisses de ravitaillement de guerre ?"
...
L["Notify your group about incoming War Supply Crates?"] = "Avertir votre groupe de l'arrivée de caisses de ravitaillement de guerre ?"
...
L["Purge logged War Supply Crate Locations timeframe?"] = "Quel est le délai de purge des emplacements enregistrés de caisses de ravitaillement de guerre ?"
...
L["This will automatically display a message showing your Kill Stream upon getting a Killing Blow."] = "Cela affichera automatiquement un message indiquant votre série d'éliminations lorsque vous porterez le coup fatal."
...
L["This will automatically equip your PVP Gear Set inside PVP content."] = "Cela équipera automatiquement votre ensemble d'équipement PVP dans le contenu PVP."
...
L["This will automatically play a sound when you score a Killing Blow."] = "Cela jouera automatiquement un son lorsque vous infligerez un Coup fatal."
...
L["This will automatically take a screenshot when you score a Killing Blow."] = "Cela prendra automatiquement une capture d'écran lorsque vous porterez un coup fatal."
...
L["This will save some key locations when a War Supply Crate is detected."] = "Cela sauvegardera certains emplacements clés lorsqu'une Caisse de ravitaillement de guerre sera détectée."
...
L["This will send messages to your group about incoming War Supply Crates."] = "Cela enverra des messages à votre groupe concernant les caisses de ravitaillement de guerre entrantes."
...
L["This will show you warning messages for critical events around Slayer's Rise."] = "Ceci affichera des messages d'avertissement concernant les événements critiques liés à l'Ascension du Tueur."
...
L["Found: %d War Supply Crate Locations."] = "Trouvé : %d emplacements de caisses de ravitaillement de guerre."
L["Harmful Auras:"] = "Auras nocives :"
L["Helpful Auras:"] = "Auras utiles :"
L["Instance ID: %d"] = "ID d'instance : %d"
L["Last Estimated Spawn Time: %s"] = "Dernière heure d'apparition estimée : %s"
...
L["Kick: %s?"] = "Coup de pied : %s ?"
L["Kick: %s for %s?"] = "Coup de pied : %s pour %s ?"
L["Send"] = "Envoyer"
L["Send: %s?"] = "Envoyer: %s ?"
...
L["You've been removed from the party for %s."] = "Vous avez été exclu du parti pour %s."
...
-- Battlegrounds.lua
L["%s Players that left: %s"] = "%s joueurs qui sont partis : %s"
