...
-----------------------
v1.34.001:
-Block game menu hotkeys inside PVP content will now block the Housing Dashboard opening in PVP content.
-Add new Housing Options -> Mark treasure location for Decor Treasure Hunt Quest?