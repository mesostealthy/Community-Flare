...
-----------------------
v1.21.001
-NEW Player List Manager: Can view all Players seen in Battlegrounds / PVP matches.
-NEW Party Setting: Always request party leadership to auto request party lead upon joining a new party.
--Can Add/Remove Players to/from Kill On Sight list. This will display a Raid Warning when they're in your matches!
--Can Add/Edit Notes to individual Players.
-Korrak's Revenge: Added some more stuff for queuing/reporting with Raids.
-NEW Command: /comf plm to open the Player List Manager.
-NEW Debug Command: /comf perf to see the Performance Metrics for Community Flare.
-NEW Debug Command: /comf vehicles to view all vehicles in your current location.
-Bumped TOC to v11.0.7
